        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-lg text-gray-700">
              ...
              <p className="bg-blue-50 p-6 rounded-xl border-l-4 border-gedwel-blue">
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-2xl font-bold text-gedwel-dark mb-4">Our Mission</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-2xl font-bold text-gedwel-dark mb-4">Our Vision</h3>
              <p className="text-gray-700 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {coreValues.map((value, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition duration-300 border border-gray-100">
                ...
                <h3 className="text-xl font-bold text-gedwel-dark mb-3">{value.title}</h3>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-gedwel-dark">Quality Assurance</h3>
              ...
              <ul className="space-y-3">
                {commitments.slice(0, 2).map((item, index) => (
                  <li key={index} className="flex items-start space-x-3">
                    ...
                    <div>
                      <strong className="text-gedwel-dark">{item.title}:</strong>
            ...
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-gedwel-dark">Safety Standards</h3>
              <p className="text-gray-700">
