const ServiceCard = ({ icon, title, description, features }) => {
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition duration-300 transform hover:-translate-y-1 animate-fade-in">
      <div className="p-6">
        {/* Icon */}
        ...
        {/* Title */}
        <h3 className="text-xl font-bold text-gedwel-dark mb-4 text-center">{title}</h3>
