const ProjectCard = ({ title, category, description }) => {
  ...
  return (
    <div className="group bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition duration-300 transform hover:-translate-y-1 animate-fade-in">
      {/* Image */}
      ...
      <div className="p-6">
        {/* Category Badge */}
        <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium mb-3 ${categoryColors[category] || 'bg-gray-100 text-gray-800'}`}>
          {category}
        </span>
        
        {/* Title */}
        <h3 className="text-xl font-bold text-gedwel-dark mb-3 group-hover:text-gedwel-blue transition duration-300">
          {title}
        </h3>
        ...
        {/* View Details Button */}
        <button className="text-gedwel-blue hover:text-gedwel-light font-medium flex items-center space-x-2 transition duration-300 group">
